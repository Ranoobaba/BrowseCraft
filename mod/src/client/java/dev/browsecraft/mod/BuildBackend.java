...
public interface BuildBackend {
    ...
    List<SessionSummary> listSessions(String clientId, String worldId) throws IOException, InterruptedException;

    void switchSession(String clientId, String worldId, String sessionId) throws IOException, InterruptedException;

    void reportBuildResult(String jobId, BuildApplyResult result);
